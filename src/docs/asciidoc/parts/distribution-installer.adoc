...
Access to the following Gradle objects are available:

* `Project` - link:{groovydoc}/AbstractDistributionInstaller.html#getProject()[getProject]
* 'Logger` - link:{groovydoc}/AbstractDistributionInstaller.html#getLogger()[getLogger]

Access to (unpacked) directory content:
