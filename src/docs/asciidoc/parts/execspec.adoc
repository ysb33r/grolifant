...
....
               ...
               |                           |
/--------------+----------\   /------------+-----------\
| AbstractCommandExecSpec |   | AbstractScriptExecSpec |
\-------------------------/   \------------------------/
....
...
[source,groovy]
----
include::{compatdir}/AbstractCommandExecSpecSpec.groovy[indent=0,tags=declarative]
----
...
[source,groovy]
----
include::{compatdir}/AbstractCommandExecSpecSpec.groovy[indent=0,tags=environment]
----
...
[source,groovy]
----
include::{compatdir}/AbstractCommandExecSpecSpec.groovy[indent=0,tags=executable]
----
...
[source,groovy]
----
include::{compatdir}/AbstractCommandExecSpecSpec.groovy[indent=0,tags=command]
----
...
[source,groovy]
----
include::{compatdir}/AbstractCommandExecSpecSpec.groovy[tags=example-exec-spec,indent=0]
----
...
link:{groovydoc}/ExtensionUtils#addProjectExecExtension(java.lang.String,org.gradle.api.Project,ExecSpecInstantiator)[ExtensionUtils.addProjectExtension] is the key method to use.
...
[source,groovy]
----
include::{compatdir}/ExecProjectExtensionSpec.groovy[tags=example-exec-spec,indent=0]
----
...
include::{compatdir}/ExecProjectExtensionSpec.groovy[tags=adding-extension,indent=2]
}
----
<1> An instantiator is required to create instances of execution specifications on demand. One simple way is to create a closure an coerce it to a {groovydoc}/ExecSpecInstantiator.html[ExecSpecInstantiator]
...
There is currently three abstract task classes in the hierachy.
...
....
               ...
               |                           |
/--------------+----------\   /------------+-----------\
| AbstractCommandExecTask |   | AbstractScriptExecTask |
\-------------------------/   \------------------------/
....
...
//=== Advanced: Preventing executable being set
